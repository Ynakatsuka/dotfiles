...
description: >-
  Remove "AI slop" from Japanese prose so AI-drafted text reads like a human wrote it.
  Fixes not just em-dashes and pet phrases, but absent authorship, proposition-style H2s,
  grandiosity, both-sides hedging, and uniform rhythm. Use when drafting, editing, or
